 ...
 * </p>
 */
@ConfigurationProperties(prefix = "nad", ignoreUnknownFields = false)
public class NaddameProperties {
    ...
    public static class Swagger {
        ...
        private String title = "Restaurant API";

        private String description = "Restaurant API documentation";
